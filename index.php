...
<body>
    ...
    <div id="main" class="min-h-[100vh] bg-[#efeae3]  py-8 overflow-hidden">
        ...
        <div class="flex w-full h-[69.5vh] items-end  pb-8  justify-between  border-b border-[#b7b3ae] px-8">
        ...
        <div class="video relative flex items-center justify-center w-full px-8">
        ...
        <div class="overflow-x-auto whitespace-nowrap py-[15vh] scollbar-hidden slider-parent">
            <div class=" inline-block whitespace-nowrap slider">
                <h2 class="inline-block text-[9vw]">CONTENT</h2>
                <div class="inline-block w-[5vw] h-[5vw] mx-[2.8vw] mb-[1vw] rounded-full bg-[#fe320a]"></div>
                <h2 class="inline-block text-[9vw]">ENVIRONMENTS</h2>
                <div class="inline-block w-[5vw] h-[5vw] mx-[2.8vw] mb-[1vw] rounded-full bg-[#fe320a]"></div>
